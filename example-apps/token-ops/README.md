...
3. **[`src/components/`](src/components/)** — the five tab views (Dashboard, Operations, Pending, Governance, Settings plus the top-bar [`LoginModal`](src/components/LoginModal.tsx) (mnemonic/WIF sign-in), [`ConfirmActionPanel`](src/components/ConfirmActionPanel.tsx), [`IdentityLabel`](src/components/IdentityLabel.tsx), [`CopyableId`](src/components/CopyableId.tsx), [`AppNotices`](src/components/AppNotices.tsx), and [`TopNav`](src/components/TopNav.tsx) (Sign in / Sign out).
