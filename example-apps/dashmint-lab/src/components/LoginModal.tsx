              ...
              <label className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="group relative cursor-help">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-5 text-ink-4 transition group-hover:text-ink-2">
                      <path fillRule="evenodd" d="M15 8A7 7 0 1 1 1 8a7 7 0 0 1 14 0Zm-6 3.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM7.293 5.293a1 1 0 1 1 .324 1.647.5.5 0 0 0-.617.489v.671a.75.75 0 0 0 1.5 0v-.105a2.5 2.5 0 1 0-3.056-3.282.75.75 0 0 0 1.414.498 1 1 0 0 1 .435-.918Z" clipRule="evenodd" />
                    </svg>
                    <span className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-1.5 w-48 -translate-x-1/2 rounded-md bg-surface-2 px-2.5 py-1.5 text-[10px] font-normal normal-case tracking-normal text-ink-2 opacity-0 shadow-[0_12px_28px_-8px_rgba(0,0,0,0.6)] transition group-hover:opacity-100">
                      Usually 0. Only change this if you have multiple identities derived from the same mnemonic.
                    </span>
                  </span>
                </div>
              </label>
